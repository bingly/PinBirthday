...
//	Fragment konw_fragment, wantknow_fragment, me_fragment, current_fragment;
//	TextView tv_know, tv_wantknow, tv_me;
//	ImageView iv_know, iv_wantknow, iv_me;
//	RelativeLayout know_layout, wantknow_layout, me_layout; 
	...
	public void initView(){
		...
		iWantKnowImg = (ImageView) findViewById(R.id.iv_want_know);
		meImg = (ImageView) findViewById(R.id.iv_me);
		knowTv = (TextView) findViewById(R.id.tv_know);
		iWantKnowTv = (TextView) findViewById(R.id.tv_want_know);
	...
	private void clickTab2Layout() {
		if (iWantKnowFragment == null) {
			iWantKnowFragment = new WantKnowFragment();
		}
